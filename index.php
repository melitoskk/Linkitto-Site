                ...
                <div class="product-row">
                    ...
                    if ($result_produtos_recent->num_rows > 0) {
                        while ($produto = $result_produtos_recent->fetch_assoc()) {
                            ...
                            echo "<p class='product-category'>Categoria: " . htmlspecialchars($produto['categoria_nome']) . "</p>";
                    ...
                    while ($categoria = $result_categorias->fetch_assoc()) {
                        ...
                        if ($result_produtos_categoria->num_rows > 0) {
                            ...
                            while ($produto = $result_produtos_categoria->fetch_assoc()) {
                                ...
                                echo "<p class='product-id'>ID: " . $produto['id_produto'] . "</p>"; // Continua exibindo 'id_produto' aqui, sem alteração
                
                                echo "<small class='disclaimer'>
                                Você comprará por <a href='" . $produto['link_loja'] . "' target='_blank'>" . htmlspecialchars($produto['nome_loja']) . "</a>
                              </small>"; // Nome da loja com link
                                echo "<a href='" . $produto['link_produto'] . "' target='_blank' onclick='registerClick(" . $produto['id_produto'] . ")' class='buy-button'>Ver Produto</a>"; // Mantém o 'id_produto' na função de clique
